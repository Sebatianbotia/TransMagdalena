...
class SeatHoldMapperTest {
    ...
    void testUpdateEntity() {
        User user = User.builder()
                ...
                .phone("3000000000")
                .rol(UserRols.CLERK)
                .createdAt(LocalDateTime.now()) // Agregar campo obligatorio
                .build();

        Trip trip = Trip.builder()
                .id(5L)
                .arrivalAt(LocalTime.of(10, 0)) // Corregido: usar LocalTime
                .departureAt(LocalTime.of(9, 0)) // Corregido: usar LocalTime
                .date(java.time.LocalDate.now()) // Agregar campo obligatorio
                .tripStatus(com.example.transmagdalena.trip.TripStatus.SCHEDULED) // Agregar campo obligatorio
                .build();
    ...
    void testToSeatHoldDTO() {
        ...
        Trip trip = Trip.builder()
                .id(7L)
                .arrivalAt(LocalTime.of(18, 30)) // Corregido: usar LocalTime
                .departureAt(LocalTime.of(16, 30)) // Corregido: usar LocalTime
                .date(java.time.LocalDate.now()) // Agregar campo obligatorio
                .tripStatus(com.example.transmagdalena.trip.TripStatus.SCHEDULED) // Agregar campo obligatorio
                .build();
    ...
    void testToUserDTO() {
        ...
        SeatHoldDTO.userDTO ud = seatHoldMapper.toDTO(user); // Cambiar nombre del método si es necesario
    ...
    void testToTripDTO() {
        Trip trip = Trip.builder()
                .id(9L)
                .arrivalAt(LocalTime.of(12, 0)) // Corregido: usar LocalTime
                .departureAt(LocalTime.of(10, 0)) // Corregido: usar LocalTime
                .date(java.time.LocalDate.now()) // Agregar campo obligatorio
                .tripStatus(com.example.transmagdalena.trip.TripStatus.SCHEDULED) // Agregar campo obligatorio
                .build();

        SeatHoldDTO.tripDTO td = seatHoldMapper.toDTO(trip); // Cambiar nombre del método si es necesario

        assertNotNull(td);
        assertEquals(9L, td.id());
        // Los assertions de tiempo dependen de cómo esté mapeado en tu DTO
    }
    ...
    void testToSeatDto() {
        ...
        SeatHoldDTO.seatDto sd = seatHoldMapper.toDTO(seat); // Cambiar nombre del método si es necesario
