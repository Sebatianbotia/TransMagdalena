...
public class TicketMapperTest {
    ...
    public void toDto() {
        Trip trip = Trip.builder().id(1L).date(OffsetDateTime.MAX).build();
        ...
        Stop origin = Stop.builder().id(1L).name("fundacin").lat(22).lng(222).build();
        Stop destination = Stop.builder().id(2L).name("santa marta").lat(223).lng(2222).build();
