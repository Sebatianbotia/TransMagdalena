...
class AssignmentMapperTest {
    ...
    void toDTO() {
        ...
        Trip trip = Trip.builder().id(1L).departureAt(LocalTime.now()).arrivalAt(LocalTime.now().plusHours(12)).build();
    ...
    void updateEntity() {
        ...
        Trip trip = Trip.builder().id(6L).departureAt(LocalTime.now()).arrivalAt(LocalTime.now().plusHours(12)).build();
