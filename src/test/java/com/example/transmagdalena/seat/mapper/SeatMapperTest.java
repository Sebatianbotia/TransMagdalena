...
class SeatMapperTest {
    ...
    void testUpdateSeat() {
        ...
        assertEquals(BusStatus.MAINTENANCE, existing.getBus().getStatus());
    }
    ...
    void testToSeatResponse() {
        ...
        assertEquals(BusStatus.ACTIVE, response.bus().status());
    }
    ...
    void testToBusDTO() {
        ...
        assertEquals(BusStatus.ACTIVE, busDto.status());
    }
